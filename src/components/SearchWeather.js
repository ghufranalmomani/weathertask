...
const SearchWeather = () => {
    ...
    useEffect(() => {
        const fetchweather = async () =>{
            const response = await fetch('https://api.openweatherrmap.org/data/2.5/weather?q=${search}&appid=32e7a9d44328b888755530d35b7c40b6f');
            if(componentMounted){
                            ...
                            <div class="card-img-overlay">
                                <form onSubmit={handleSubmit}>
                                    <div class="input-group mb-4 w-75 mx-auto">
                                        ...
                                        required
                                        />
                                            <button tybe="submit" class="input-group-text" id="basic-addon2">
